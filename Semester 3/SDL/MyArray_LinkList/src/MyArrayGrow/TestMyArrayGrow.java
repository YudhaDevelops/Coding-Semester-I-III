package MyArrayGrow;
public class TestMyArrayGrow {
    public static void main(String[] args) {
        System.out.println("MyArrayGrow Test");
        System.out.println("================");
        System.out.println("Inisialisasi");
        MyArrayGrow myArr1 = new MyArrayGrow(10);
        ...
        System.out.println("\nKetika ditambahkan 26 data (lebih dari kapasitasnya yaitu 10 data)");
        for(char i = 'A'; i <= 'Z'; i++)
            myArr1.addRear(i);
        System.out.print("bisa masuk karena grow()      myArr1 = ");
        System.out.println(myArr1);
