 ...
 * @author Andreas
 */
public class TestMyCircularHeadedDoubleLinkedList {
    public static void main(String[] args) {
        MyCircularHeadedDoubleLinkedList test1;

        System.out.println("Test MyCircularHeadedDoubleLinkedList");
        System.out.println("=====================================");
        System.out.println("\nConstructor() & toString");
        test1 = new MyCircularHeadedDoubleLinkedList();
        ...
        System.out.println("\nMethod insertAt() & delAt()");
        System.out.print("addTail('A')              myLinkedList = ");
        test1.addTail('A');
        System.out.println(test1);
        System.out.print("insertAt(0, 'B')          myLinkedList = ");
        test1.insertAt(0, 'B');
        System.out.println(test1);
        System.out.print("insertAt(1, 'C')          myLinkedList = ");
        test1.insertAt(1, 'C');
        System.out.println(test1);
        System.out.print("insertAt(-1, '*')         myLinkedList = ");
        test1.insertAt(-1, '*');
        System.out.print("insertAt(3, '*')          myLinkedList = ");
        test1.insertAt(3, '*');
//        System.out.println(test1);
        System.out.print("delAt(-1) => " + test1.delAt(-1) + "            myLinkedList = ");
        System.out.println(test1);
        System.out.print("delAt(3) => " + test1.delAt(3) + "             myLinkedList = ");
        System.out.println(test1);
        System.out.print("delAt(1) => " + test1.delAt(1) + "             myLinkedList = ");
        System.out.println(test1);
        System.out.print("delAt(1) => " + test1.delAt(1) + "             myLinkedList = ");
        System.out.println(test1);
        System.out.print("delAt(0) => " + test1.delAt(0) + "             myLinkedList = ");
        System.out.println(test1);
        System.out.print("delAt(0) => " + test1.delAt(0) + "             myLinkedList = ");
        System.out.println(test1);
        System.out.print("insertAt(0, '*')          myLinkedList = ");
        test1.insertAt(0, '*');
        ...
        System.out.println("Search F   => " + test1.searchData('F'));
